...
export async function getStaticProps ({ params }) {
  ...
  const Blogs = blogPosts.data.data.blogs.filter(blog => blog !== null).sort((a, b) => new Date(b.published_at) - new Date(a.published_at))
  // const Blogs = blogPosts.data.data.blogs.sort((a, b) => new Date(strapiDateToDateString(b.Publication)) - new Date(strapiDateToDateString(a.Publication)))
