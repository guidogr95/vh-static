...
// Assets
import ColorLogo from 'public/assets/media/brand/std-vertical-color.svg'
    ...
    return (
        <>
            ...
            <style jsx>{`
                ...
                article ._thumbnail {
                    padding-bottom: 55%;
                    background: url(${Thumbnail}), ${ThumbnailBgColorHex || '#fff'};
                    background-size: 100%;
                ...
                article ._thumbnail.no-thumbnail {
                    ...
                    background: url(${ColorLogo}), ${ThumbnailBgColorHex || colors.day};
                }
                article:hover {
