...
const RangeSlider = React.memo(({ themeColor, min, max, steps, handleSlider, value, indexValues }) => {
    ...
    const sliderPercentage = indexValues ? indexValues[value] / indexMax * 100 : value / innerMax * 100
                ...
                <div className="range">
                    ...
                    <div className="field">
                        ...
                        <input
                            ...
                            max={innerMax}
                            value={value}
                            step={typeof steps === 'function' ? steps(value) : typeof steps === 'undefined' ? 1 : steps}
