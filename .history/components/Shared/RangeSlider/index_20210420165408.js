...
const RangeSlider = React.memo(({ themeColor, min, max, handleSlider, value, showRange, pricingIndex }) => {
    ...
    const indexMax = indexValues ? indexValues[Object.keys(indexValues).length].baseMultiplier : innerMax
    const indexMin = indexValues ? indexValues[1].baseMultiplier : innerMin
