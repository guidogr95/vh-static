...
const RangeSlider = React.memo(({ themeColor, min, max, steps }) => {
    ...
    const sliderPercentage = value / parseInt(max) * 100
        ...
        <>
            <div className="rslider-container" >
                <div className="range">
                    ...
                    <div className="field">
                        <div className="value left">{min || 0}</div>
                        <div className="value right">{max || 100}</div>
                        <input
                            type="range"
                            min={min || '0'}
                            max={max || '100'}
