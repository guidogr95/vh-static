...
const RangeSlider = React.memo(({ theme, min, max, handleSlider, value, showRange, indexValues }) => {
    ...
    const indexLength = Object.keys(indexValues).length
    const innerMax = max || indexLength
    const innerMin = min || 1
    const indexMax = indexValues ? indexValues[indexLength] : innerMax
        ...
        <>
            ...
            <style jsx>{`
                ...
                .sliderValue span {
                    ...
                    transform: translateX(${-(bubbleWidth / 2) + (thumbWidth / 2) + (value / 100 * 1)}px) scale(${active ? 1 : 1});
                    font-weight: 500;
                    top: -30px;
                    line-height: 55px;
                    z-index: 2;
                ...
                .sliderValue span:after {
                    ...
                    height: 100%;
                    width: 100%;
                    background: ${theme?.themeBackground || colors.day};
                ...
                .field .value {
                    position: absolute;
                    font-size: 18px;
                    color: ${theme?.themeColor || colors.day};
                    font-weight: 600;
                    display: none;
                }
                ...
                .range input::-webkit-slider-thumb {
                    ...
                    border-radius: 50%;
                    background: ${theme?.themeBackground || colors.day};
                    border: 1px solid ${theme?.themeColor || colors.day};
                    cursor: pointer;
                    z-index: 3;
                    position: relative;
                }
